...
def test_redundancy(hscore, body_cageA, body_cageB):
    ...
    iuniq4 = rp.filter_redundancy(xforms,
                                  result.bodies[0],
                                  scores,
                                  symframes=spec.sym,
                                  **kw.sub(max_bb_redundancy=4.0))
    iuniq3 = rp.filter_redundancy(xforms,
                                  result.bodies[0],
                                  scores,
                                  symframes=spec.sym,
                                  **kw.sub(max_bb_redundancy=3.0))
    iuniq2 = rp.filter_redundancy(xforms,
                                  result.bodies[0],
                                  scores,
                                  symframes=spec.sym,
                                  **kw.sub(max_bb_redundancy=2.0))
    iuniq1 = rp.filter_redundancy(xforms,
                                  result.bodies[0],
                                  scores,
                                  symframes=spec.sym,
                                  **kw.sub(max_bb_redundancy=1.0))
