...
def test_cage_hier_onecomp_notrim(hscore, bodyC3):
    ...
    sampler = rp.sampling.hier_axis_sampler(spec.nfold,
                                            lb=0,
                                            ub=100,
                                            resl=10,
                                            angresl=10,
...
def test_cage_grid_onecomp_notrim(hscore, bodyC3):
    ...
    sampler = rp.sampling.grid_sym_axis(np.arange(0, 100, 2),
                                        np.arange(0, 360 / spec.nfold, 2),
                                        axis=spec.axis,
...
def test_deepesh_1comp_bug(hscore):
    ...
    kw.sampler = rp.sampling.hier_axis_sampler(spec.nfold,
                                               lb=147,
                                               ub=154,
                                               resl=10,
                                               angresl=10,
